...
<footer class="footer">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div class="contact-box__info">
          <a class="contact-box__info--title">{{ company_info()->phone }}</a>
          <p class="contact-box__info--subtitle">{{ company_info()->call_time }}</p>
        </div>
      </div>  
      ...
      <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div class="contact-box__info">
          <a href="#" class="contact-box__info--title">{{ company_info()->mail }}</a>
      ...
      <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div class="contact-box__info">
          <a href="#" class="contact-box__info--title">{{ company_info()->city }}, {{ company_info()->country }}</a>
          <p class="contact-box__info--subtitle">{{ company_info()->location }}</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- START THE SOCIAL MEDIA CONTENT  -->
    <div class="footer-sm {{ company_social()->isEmpty() ? 'd-none' : '' }}" style="background-color: #212121;">
      <div class="container">
        <div class="row py-4 text-center text-white">
          ...
          <div class="col-lg-7 col-md-6">
            @foreach (company_social() as $c_social)  
              <a href="{{ $c_social->link }}" target="_blank"><i class="{{ $c_social->icon }}"></i></a>
            @endforeach
          </div>
        </div>
      </div>
  ...
  <div class="container mt-5">
    <div class="row text-white justify-content-center mt-3 pb-3">
      <div class="col-12 col-sm-6 col-lg-6 mx-auto">
        <h5 class="text-capitalize fw-bold">{{ company_info()->name }}</h5>
        <hr class="bg-white d-inline-block mb-4" style="width: 60px; height: 2px;">
        <p class="lh-lg">{{ company_info()->description }}</p>
      </div>
      ...
      <div class="row text-center text-white">
        <div class="col-12">
          <div class="footer-bottom__copyright">
            <a href="#home">{{ company_info()->name }}</a> | {{ company_info()->title }}
          </div>
        </div>
      </div>
    </div>
